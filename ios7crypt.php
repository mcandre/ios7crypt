...
if (array_key_exists("hash", $_GET)) {
	...
	if (filter_var($h, FILTER_VALIDATE_REGEXP, array("options"=>array("regexp"=>"/^[a-fA-F0-9]+$/")))) {
		$hash=$h;
	}
}
...
<form action="ios7crypt.php" method="get">
	<p><label for="password">Password</label> <input id="password" type="text" name="password" value="<? echo $password ?>" /></p>
</form>
<form action="ios7crypt.php" method="get">
	<p><label for="hash">Hash</label> <input id="hash" type="text" name="hash" value="<? echo $hash ?>" /></p>
</form>
